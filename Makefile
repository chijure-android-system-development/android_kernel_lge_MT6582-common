...
#LGE_CHANGE_S namgyu.kim 2014.09.29 for LGE model feature by MTK chipset
ifeq ($(CONFIG_ARCH_MTK_PROJECT),"muse6582_y90_l")
KBUILD_CFLAGS += -DTARGET_MT6582_Y90
endif

ifeq ($(CONFIG_ARCH_MTK_PROJECT),"muse6582_y70_l")
KBUILD_CFLAGS += -DTARGET_MT6582_Y70
endif

ifeq ($(CONFIG_ARCH_MTK_PROJECT),"muse6732_c90_l")
KBUILD_CFLAGS += -DTARGET_MT6732_C90
endif

ifeq ($(CONFIG_ARCH_MTK_PROJECT),"muse6582_y50_l")
KBUILD_CFLAGS += -DTARGET_MT6582_Y50
endif
ifeq ($(CONFIG_ARCH_MTK_PROJECT),"muse6582_b2l_l")
KBUILD_CFLAGS += -DTARGET_MT6582_B2L
endif
ifeq ($(CONFIG_ARCH_MTK_PROJECT),"muse6582_l80_l")
KBUILD_CFLAGS += -DTARGET_MT6582_L80
endif

ifeq ($(CONFIG_ARCH_MTK_PROJECT),"muse6582_p1s3g_l")
KBUILD_CFLAGS += -DTARGET_MT6582_P1S3G
endif

ifdef MULTISIM
KBUILD_CFLAGS += -D$(MULTISIM)
endif

ifdef HW_REV
KBUILD_CFLAGS += -DLGE_HW_$(HW_REV)
else
KBUILD_CFLAGS += -DLGE_HW_EVB
endif
