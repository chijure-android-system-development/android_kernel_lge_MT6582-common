...
#if 1//defined (TARGET_MT6582_Y70) || defined (TARGET_MT6582_Y90)|| defined (TARGET_MT6732_C90)
...
#if 0//defined (CONFIG_TOUCHSCREEN_SYNAPTICS_S7020)
...
#ifdef CONFIG_ARCH_MT6595 //FIXME, wait ME5 check
	TPD_RES_X = 1080;//DISP_GetScreenWidth();
	TPD_RES_Y = 1920;//DISP_GetScreenHeight();
#else
	TPD_RES_X = DISP_GetScreenWidth();
	TPD_RES_Y = DISP_GetScreenHeight();
#endif
	#if defined (CONFIG_TOUCHSCREEN_SYNAPTICS_S3528)
	int TPD_RES_X = 1100;
	int TPD_RES_Y = 1900;
	#endif
	#if defined (CONFIG_TOUCHSCREEN_SYNAPTICS_S7020)
	int TPD_RES_X = 959;
	int TPD_RES_Y = 1707;
	#endif
...
#if 0//!defined(TARGET_MT6582_Y70) && !defined(TARGET_MT6582_Y90)&& !defined(TARGET_MT6732_C90)
...
#if  0 //defined (CONFIG_TOUCHSCREEN_SYNAPTICS_S3528)
