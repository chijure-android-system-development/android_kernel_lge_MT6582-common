...
static const char defaultFirmware[] = "synaptics/y90/PLG465-V1.10-PR1815155-DS5.2.12.0.13-4005018A.img";
...
static const char defaultFirmware[] = "synaptics/c90/PLG465-V1.10-PR1815155-DS5.2.12.0.13-4005018A.img";
#else
...
#if defined(ENABLE_SWIPE_MODE)
			if(ts->lpwgSetting.coverState || lockscreen_stat==0) {
