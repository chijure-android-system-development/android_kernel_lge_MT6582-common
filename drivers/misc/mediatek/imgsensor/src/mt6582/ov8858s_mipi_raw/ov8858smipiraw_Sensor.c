...
void OV8858S_Init_Para(void)
{
	...
	OV8858S.pvPclk =  (7200); 
	OV8858S.videoPclk = (14400);
	OV8858S.capPclk = (14400);
...
kal_uint32 OV8858S_CalcFrameLength_For_AutoFlicker(void)
{
	...
	switch(OV8858SCurrentScenarioId)
	{
		...
		case MSDK_SCENARIO_ID_CAMERA_CAPTURE_JPEG:
			AutoFlicker_min_framelength = (OV8858S.capPclk*10000) /(OV8858S_FULL_PERIOD_LINE_NUMS + OV8858S.DummyPixels)/OV8858S_AUTOFLICKER_OFFSET_30*10 ;
			break;
